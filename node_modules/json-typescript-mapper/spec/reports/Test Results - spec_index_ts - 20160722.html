...
<title>Test Results &mdash; spec\index.ts</title>
<style type="text/css">
          html {
            height: 100%
          }
...
<h1>spec\index.ts: <strong><span class="total">10 total, </span><span class="failed">1 failed, </span><span class="passed">9 passed</span></strong>
</h1>
<div id="treecontrol">
<ul>
<li>
...
</em><em class="status">passed</em>simple json object #1</span>
</li>
<li class="level test">
<span><em class="time">
<div class="time">3 ms</div>
</em><em class="status">passed</em>simple json object #2</span>
</li>
<li class="level test">
<span><em class="time">
<div class="time">9 ms</div>
</em><em class="status">passed</em>complex json object #1</span>
</li>
<li class="level test failed open">
<span><em class="time">
<div class="time">0 ms</div>
</em><em class="status">failed</em>empty json object #1</span>
<ul>
<li class="text">
<span class="stdout">Person {<br/>  name: undefined,<br/>  surname: undefined,<br/>  age: undefined,<br/>  addressArr: undefined,<br/>  address: null }<br/></span>
</li>
<li class="text">
<span class="stderr">AssertionError: expected null to equal undefined<br/></span>
</li>
</ul>
</li>
<li class="level test">
<span><em class="time">
<div class="time">0 ms</div>
</em><em class="status">passed</em>empty json object #2</span>
</li>
<li class="level test">
<span><em class="time">
<div class="time">0 ms</div>
</em><em class="status">passed</em>empty json object #3</span>
</li>
<li class="level test">
<span><em class="time">
<div class="time">1 ms</div>
</em><em class="status">passed</em>invalid primitive value #1</span>
<ul>
<li class="text">
<span class="stdout">null<br/></span>
</li>
</ul>
</li>
<li class="level test">
<span><em class="time">
<div class="time">0 ms</div>
</em><em class="status">passed</em>invalid primitive value #2</span>
</li>
<li class="level test">
<span><em class="time">
<div class="time">0 ms</div>
</em><em class="status">passed</em>invalid primitive value #3</span>
</li>
<li class="level test">
<span><em class="time">
<div class="time">1 ms</div>
</em><em class="status">passed</em>invalid json object #1</span>
</li>
</ul>
</li>
</ul>
...
<div id="footer">
<p>Generated by WebStorm on 16-7-22 上午9:54</p>
</div>
</body>
</html>
