...
exports.CompanyData = void 0;
const CompanyData_1 = require("./models/CompanyData");
...
class CompanyData {
    constructor(source, token, type, num, proxy) {
        this.source = source;
        this.token = token;
        this.type = type;
        this.num = num;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                if (this.source.toLocaleUpperCase() === 'CEIDG') {
                    const data = [];
                    try {
                        const model = yield GetDataFromNewCeidg(this.num, this.token, this.proxy);
                        data.push(model);
                        return resolve(data);
                    }
                    catch (error) {
                    ...
                    const gusSid = yield generateGusSid(this.token, this.proxy);
                    let regon = '';
                    if (this.type.toLocaleLowerCase() === 'nip') {
                        this.type = 'Nip';
                        regon = yield findGusData(gusSid, this.type, this.num, this.proxy);
                    }
                    else {
                        regon = this.num;
                    }
                    const myObj = yield findGusFullReport(gusSid, regon, this.proxy, 'BIR11OsPrawna');
...
function GetDataFromNewCeidg(nip, token, proxy) {
    return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                request(options, (error, response) => {
                    ...
                    if (response.statusCode === 200) {
                        ...
                        let jsonObj = jsonObjX.firma.find((myObj) => {
                            return myObj.status.toLocaleLowerCase() === 'aktywny';
                        });
                        if (jsonObj === undefined) {
                            jsonObj = jsonObjX.firma[0];
                        }
                        const model = new CompanyData_1.CompanyDataCeidg();
                        ...
                        const retObj = new Response_1.ResponseData('CEIDG', model);
...
function generateGusSid(apiKey, proxy) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const xml = `
...
function findGusData(sid, type, num, proxy) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const xml = `
...
function findGusFullReport(sid, regon, proxy, reportName) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const xml = `
          <soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:ns="http://CIS/BIR/PUBL/2014/07">
            ...
            try {
                request(options, (error, response) => __awaiter(this, void 0, void 0, function* () {
                    if (error) {
                        throw new Error(error);
                    }
                    ;
                    ...
                    model.DaneDodatkowe = {
                        ...
                        KodyPKD: yield findGusFullReportPkd(sid, regon, proxy, 'BIR11OsPrawnaPkd'),
                    };
                    model.DaneKontaktowe = {
...
function findGusFullReportPkd(sid, regon, proxy, reportName) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const xml = `
      <soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:ns="http://CIS/BIR/PUBL/2014/07">
            ...
            try {
                request(options, (error, response) => {
                    ...
                    if (Array.isArray(jsonObjX.root.dane)) {
                        jsonObjX.root.dane.forEach((element) => {
